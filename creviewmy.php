...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $book_info = mysqli_real_escape_string($conn, $_POST["book_info"]);
    $customer_evaluation = mysqli_real_escape_string($conn, $_POST["customer_evaluation"]);
    $star_rating = mysqli_real_escape_string($conn, $_POST["star_rating"]);
    $review_date = mysqli_real_escape_string($conn, $_POST["review_date"]);
    $all = "INSERT INTO customer_reviews (customer_name, book_info, customer_evaluation, star_rating, review_date) 
            VALUES ('$customer_name', '$book_info', '$customer_evaluation', '$star_rating', '$review_date')";
...
$result = $conn->query("SELECT * FROM customer_reviews order by review_date  desc limit 6" );
...
<body>
    ...
    <section class="texts">
        ...
        ?>
        <div class="viewbtn">
            <a class="see" href="commentp.php"><button class="view">See more</button></a>
        </div>
    </section>
    <div class="container">
    ...
    <footer class="footer">
        <div class="container footer-content">
            <div class="footer-logo-section">
                <img class="logo2" src="image/logogo2.svg" alt="Logo">
                <div class="socials">
